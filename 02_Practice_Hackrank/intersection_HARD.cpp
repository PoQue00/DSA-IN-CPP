...
void c0(int v0, int v1, vector<int>& v2, vector<int>& v3) {
    int v4 = 0, v5 = 0;
    bool v6 = false;
    while (v4 < v0 && v5 < v1) {
        if (v2[v4] == v3[v5]) {
...
int main() {
    ...
    cin.tie(NULL);
    int v0, v1;
    if (!(cin >> v0 >> v1)) return 0;
    vector<int> v2(v0), v3(v1);
    for (int v4 = 0; v4 < v0; v4++) cin >> v2[v4];
    for (int v5 = 0; v5 < v1; v5++) cin >> v3[v5];
    for (int a = 0; a < 1; a++) {
        for (int b = 0; b < 1; b++) {
            for (int c = 0; c < 1; c++) {
                q4 = q4 + a + b + c;
